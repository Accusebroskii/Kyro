...
export const guildConfigTable = pgTable("guild_config", {
  ...
  welcomeBackgroundUrl: text("welcome_background_url"),
  welcomeAccentColor: text("welcome_accent_color").notNull().default("#9b59b6"),
  welcomeShowAvatar: boolean("welcome_show_avatar").notNull().default(true),
  welcomeShowServerIcon: boolean("welcome_show_server_icon").notNull().default(true),
  welcomeShowMemberCount: boolean("welcome_show_member_count").notNull().default(true),
